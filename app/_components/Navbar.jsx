  ...
  return (
    <Navbar className="w-full justify-between">
      ...
      <NavbarContent as="div" className="items-center gap-8" justify="end">
        ...
        <Button color="primary" radius="sm" className="text-lg font-bold" startContent={<Icon icon="mdi:plus" width={48} height={48}
          className="text-lg"
        />}
        >
          Button</Button>
        ...
        <div className="flex gap-10 text-gray-600">
          <Icon icon="ci:bell-notification" width="24" height="24" />
